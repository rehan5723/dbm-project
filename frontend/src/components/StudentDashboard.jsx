...
export default function StudentDashboard() {
  ...
  const fetchResults = async () => {
    ...
    try {
      ...
      // Merge topper info into results for easy display
          ...
          <table className="min-w-full divide-y divide-gray-200 rounded-xl overflow-hidden shadow-md">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 tracking-wider">Subject</th>
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 tracking-wider">Marks</th>
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 tracking-wider">Topper</th>
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 tracking-wider">Topper Marks</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {results.map((r, i) => (
                <tr key={i} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">{r.subject}</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">{r.marks_obtained}</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">{r.topper_name}</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">{r.topper_marks}</td>
                </tr>
              ))}
              {results.length === 0 && (
                <tr>
                  <td colSpan={4} className="text-center text-gray-400 py-4">No results available</td>
                </tr>
              )}
            </tbody>
          </table>
